...
export class NPCSystem {
  ...
  private getLandladyFirstMeeting(): NPCInteraction {
    return {
      ...
      npcName: '房东太太',
      emotion: 'nervous',
      dialog: '（咚咚咚——急促的敲门声）\n\n门一开，拄着拐杖的房东太太站在门口，眉头紧锁：\n\n"小姑娘，房租的事我不是没提醒过你。100块一天，白纸黑字写在合同上的。"\n\n她严厉地扫了一眼你身后的房间，目光在那台直播设备上停了一秒，嘴角微微抿了一下。\n\n"整天对着那个电脑喊喊叫叫的，正经工作不找......"\n\n嘟囔着转身要走时，你注意到她顺手把楼道里别人丢的垃圾袋拎走了。',
      choices: [
        {
          id: 'polite',
          text: '阿姨对不起，我一定尽快交上。谢谢您一直照顾',
          emotion: 'happy',
          effects: { relation: 15, kindness: 5 },
          response: '（脚步顿了一下，没回头）......楼下的灯泡坏了，我让人来修。\n\n（走了两步又停下来）天冷了，别老开窗户。\n\n（你这才注意到——楼道里那盏坏了三个月的灯，昨天突然亮了。）',
        },
        {
          id: 'ask_delay',
          text: '阿姨，能不能再宽限几天？我最近真的有点困难...',
          emotion: 'nervous',
          effects: { relation: 0 },
          response: '（停下脚步，叹了口气）......行了行了，最多再给你7天。\n\n（小声嘟囔）隔壁那户连续拖了三个月我也没赶人......\n\n（走了两步，又折回来把一袋橘子放在你门口）菜场买的，吃不完。别多想。',
        },
        {
          id: 'silent',
          text: '（低着头，默默点头）',
          emotion: 'default',
          effects: { relation: 5 },
          response: '（房东太太盯着你看了几秒，嘴唇动了动，像想说什么）\n\n......算了。\n\n（转身离开。过了一会儿，你听到门外传来她训斥隔壁装修噪音的声音："大中午的钉什么钉子！不知道有人在家吗！"）',
        },
      ],
    };
  }
